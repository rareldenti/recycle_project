  ...
  <div id="app">
    <el-header>
      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
        ...
        <el-menu-item index="4" v-if="isAuthenticated"><router-link to="/orders">回收订单</router-link></el-menu-item>
        <el-menu-item index="5" v-if="isAuthenticated"><router-link to="/categories">种类编辑</router-link></el-menu-item>
